...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    Object.entries(formData).forEach(([key, value]) => {
      if (key !== 'budget' && key !== 'timeline') { // These are optional
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl lg:text-5xl font-display font-medium text-primary mb-4 tracking-tighter">
            Let's Create Your <span className="font-semibold">Dream Oasis</span>
          </h2>
          <p className="text-xl font-body text-secondary max-w-2xl mx-auto">
            Ready to transform your Dubai property? Contact us for a consultation
          </p>
        </div>
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: MapPin, title: 'Location', content: 'Dubai, UAE', delay: '400ms' },
                { icon: Clock, title: 'Hours', content: 'Sun-Thu: 8AM-6PM', delay: '500ms' },
              ].map((item, index) => (
                <div 
                  key={index}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <option value="pool-design">Pool Design & Construction</option>
                </select>
              </div>
              ...
              <div className="relative group">
                <textarea
                  ...
                  placeholder="Tell us about your vision for your Dubai property... *"
                />
              ...
              {submitStatus === 'error' && (
                <div className="flex items-center space-x-2 text-red-600 bg-red-50 p-4 rounded-lg animate-shake">
                  ...
                  <span className="font-body">Something went wrong. Please try again or call us directly.</span>
                </div>
              )}
            </form>
          </div>
