...
const ProjectsGrid: React.FC = () => {
  ...
  const categories = ['all', 'residential', 'commercial', 'gardens', 'hardscape', 'pools'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-xl font-body text-secondary max-w-2xl mx-auto">
            Discover our award-winning landscape designs that transform Dubai properties into luxury sanctuaries
          </p>
        </div>
