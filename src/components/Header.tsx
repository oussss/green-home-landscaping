...
const Header: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = () => { if (isMobileMenuOpen) setIsMobileMenuOpen(false); };
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex items-center justify-between h-full">
            {/* Logo — text only, Gugi font */}
            <button
              onClick={(e) => scrollToTop(e)}
              className="animate-slide-in-left transition-all duration-300 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 rounded-lg p-2 -m-2"
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <button
            onClick={(e) => scrollToTop(e)}
            className="transition-all duration-300 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 rounded-lg p-1 -m-1"
            aria-label="Go to home page"
          >
            <span className="text-xl text-primary" style={{ fontFamily: "'Gugi', sans-serif" }}>
              Shots Studio
            </span>
          </button>
          <button
